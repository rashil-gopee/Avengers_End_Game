...
import Model.Factory.AbstractPieceFactory;
import Model.Factory.AttackersPieceFactory;
import Model.Factory.DefendersPieceFactory;
import Model.*;
...
public class BoardBuilder {
    ...
    /**
     * This method is used to build the board for the game. This method calls Piece Model.Factory for
    ...
    {
        PieceComposite attackersDirectory = attackersPieceFactory.getPieces(players.get(0),isPowerStrategy);
        PieceComposite defendersDirectory = defendersPieceFactory.getPieces(players.get(1),isPowerStrategy);
